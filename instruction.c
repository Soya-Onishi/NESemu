...
instruction instruction_set[0x100] = {
  ...
  {PHP, ADDR_IMPLIED, 3, 1}, {ORA, ADDR_IMMEDIATE, 2, 2}, {ASL, ADDR_ACCUMELATOR, 2, 1}, {INST_UNDEF, ADDR_UNDEF, 0, 0}, 
  ...
  {PLP, ADDR_IMPLIED, 4, 1}, {AND, ADDR_IMMEDIATE, 2, 2}, {ROL, ADDR_ACCUMELATOR, 2, 1}, {INST_UNDEF, ADDR_UNDEF, 0, 0},
  ...
  {PHA, ADDR_IMPLIED, 4, 1}, {EOR, ADDR_IMMEDIATE, 2, 2}, {LSR, ADDR_ACCUMELATOR, 2, 1}, {INST_UNDEF, ADDR_UNDEF, 0, 0},
  ...
  {PLA, ADDR_IMPLIED, 4, 1}, {ADC, ADDR_IMMEDIATE, 2, 2}, {ROR, ADDR_ACCUMELATOR, 2, 1}, {INST_UNDEF, ADDR_UNDEF, 0, 0},
